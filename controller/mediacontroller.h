...
private:
    ...
    // 音视频队列
    sharedPktQueue m_pktAudioBuf = std::make_shared<AVPktQueue>(2);               // max(2MB,16packets)
    sharedFrmQueue m_frmAudioBuf = std::make_shared<SPSCQueue<AVFrmItem>>(50);    // max(50frames)
